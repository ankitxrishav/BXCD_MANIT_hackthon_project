...
export default function Hero() {
  return (
    <section className="container mx-auto px-4 sm:px-6 lg:px-8 py-24 md:py-40 text-center relative overflow-hidden">
      <AnimatedWrapper type="parallax-hero">
        <GridPattern className="opacity-20 [mask-image:radial-gradient(400px_circle_at_center,white,transparent)]" />
        <div className="max-w-4xl mx-auto relative">
          <div className="mb-4 inline-block rounded-full glass-card px-4 py-1.5 text-sm font-medium text-primary-foreground/80 border border-primary/20 bg-primary/10">
