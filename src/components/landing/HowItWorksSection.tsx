...
const steps = [
    {
        ...
        image: "https://picsum.photos/seed/ai-conversation/600/400",
    ...
    },
    {
        ...
        image: "https://picsum.photos/seed/emotion-analysis/600/400",
    ...
    },
    {
        ...
        image: "https://picsum.photos/seed/ai-support/600/400",
        hint: "ai support"
    },
    {
        icon: TrendingUp,
        ...
        image: "https://picsum.photos/seed/mood-tracking/600/400",
        hint: "mood tracking"
    }
];
...
const FeatureCard = ({ icon: Icon, title, description, image, hint }: { icon: React.ElementType, title: string, description: string, image: string, hint: string }) => (
    <div className="rounded-2xl flex flex-col text-center glass-card transform transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl overflow-hidden">
        ...
        <div className="p-6 flex flex-col items-center">
            <div className="flex h-16 w-16 items-center justify-center rounded-full bg-primary/10 text-primary mb-4 ring-2 ring-primary/20 -mt-14 bg-card border-4 border-card">
