...
const items = [
    {
      ...
      header: <Skeleton src="https://picsum.photos/seed/chat-ui/800/600" alt="Chat UI" hint="chat interface" />,
    ...
    },
    {
      ...
      header: <Skeleton src="https://picsum.photos/seed/graph-ui/800/600" alt="Emotion Graph" hint="emotion graph" />,
      className: '',
    ...
    },
    {
      ...
      header: <Skeleton src="https://picsum.photos/seed/breathing-ui/800/600" alt="Breathing Animation" hint="breathing animation" />,
      className: '',
    ...
    },
    {
      ...
      header: <Skeleton src="https://picsum.photos/seed/insights-ui/800/600" alt="Personal Insights" hint="personal insights" />,
      className: 'md:col-span-2',
