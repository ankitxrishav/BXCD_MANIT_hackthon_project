...
import { BrainCircuit, Zap, HeartPulse, ShieldCheck, CalendarDays, Mic } from 'lucide-react';
...
const features = [
  ...
  {
      icon: CalendarDays,
      title: 'Mood Calendar & Trends',
      description: 'Visualize your emotional journey with an intuitive calendar and insightful charts, helping you identify patterns and track progress.',
  },
  {
      icon: Mic,
      title: 'Voice & Text Chat',
      description: 'Converse naturally with our AI through either text or voice. Emodash is designed to listen and understand in the way that feels most comfortable for you.',
  }
];
            ...
            <main className="flex-grow">
                <section id="features" className="container mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24">
                    ...
                    <div className="mt-16 grid gap-8 md:grid-cols-2 lg:grid-cols-3">
                        ...
                        <Card key={index} className="text-left h-full glass-card transform transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl hover:shadow-primary/10">
                            <CardHeader>
